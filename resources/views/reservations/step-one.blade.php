    ...
    <section class="my-5">
        <div class="container">
            <div class="row my-4 mx-1">
                ...
                rounded-3
              ">
                    <small>RESERVASI OrderUp!</small>
                    <h1 class="fw-bold">Reservasi tempat meja di OrderUp!</h1>
                    <p>Isi form dibawah dengan benar untuk reservasi di OrderUp!</p>
                    <hr />
                    <form method="POST" action="{{ route('reservations.store.step.one') }}" class="row g-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" name="email" value="{{ $reservation->email ?? '' }}"
                                placeholder="contoh : OrderUp!@example.com" class="form-control" id="email_input" />
                            @error('email')
                                <p class="register_text_error">{{ $message }}</p>
                            @enderror
                        </div>
