<h1 align="center">Selamat datang di repository OrderUp!! 👋🏻</h1>

![OrderUp!-preview](https://user-images.githubusercontent.com/46257169/184797401-19a87345-0027-4b51-a137-9e80d6177541.png)
...
<p align="center">
	<img src="https://img.shields.io/github/issues/syauqi/OrderUp!?style=flat-square">
	<img src="https://img.shields.io/github/stars/syauqi/OrderUp!?style=flat-square"> 
	<img src="https://img.shields.io/github/forks/syauqi/OrderUp!?style=flat-square">
	<img src="https://img.shields.io/github/license/syauqi/OrderUp!?style=flat-square">
...
<h2 id="tentang">🍣 Tentang OrderUp!</h2>

Website ini berperan sebagai homepage untuk menampilkan menu dan kategori makanan atau minuman apa saja yang ada di restoran anda untuk mempermudah pelanggan melihat menu dimana saja dan kapan saja. OrderUp! juga dilengkapi sistem reservasi meja untuk kemudahan pelanggan dalam memesan atau booking meja.
...
Halaman demo dapat anda akses di https://OrderUp!.herokuapp.com/ perlu diketahui server dapat tiba tiba mati atau website tidak dapat diakses, oleh karena itu baiknya anda coba di local
...
Berikut adalah daftar layanan dan aplikasi yang wajib dan diperlukan selama anda menjalankan aplikasi OrderUp! jika anda belum menginstall nya maka disarankan untuk menginstall nya terlebih dahulu
...
$ git clone https://github.com/syauqi/OrderUp!.git
...
-   OrderUp! adalah aplikasi web open-source yang berlisensi dibawah lisensi MIT
